...
object DensityUtil {
     ...
     * @return      px值
     */
    fun dp2px(dpVal: Float): Int = TypedValue.applyDimension(
     ...
     * @return      px值
     */
    fun sp2px(spVal: Float): Int = TypedValue.applyDimension(
     ...
     * @return      dp值
     */
    fun px2dp(pxVal: Float): Float = pxVal / Resources.getSystem().displayMetrics.density
     ...
     * @return      sp值
     */
    fun px2sp(pxVal: Float): Float = pxVal / Resources.getSystem().displayMetrics.scaledDensity
